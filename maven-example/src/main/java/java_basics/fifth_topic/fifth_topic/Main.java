...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            Class pageClass1 = Class.forName("java_basics.fifth_topic.fifth_topic.BankTransferPage");
            Class pageClass2 = Class.forName("java_basics.fifth_topic.fifth_topic.CreditCardPayPage");
            Class pageClass3 = Class.forName("java_basics.fifth_topic.fifth_topic.DigitalWalletPayPage");

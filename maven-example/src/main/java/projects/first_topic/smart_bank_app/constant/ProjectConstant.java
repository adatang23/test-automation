...
public class ProjectConstant {
    ...
    public static final String SQL_FIND_BY_LOAN_APPLICATION_ID = "SELECT * FROM LoanApplication WHERE application_id = ?;";
    ...
    public static final String SQL_UPDATE_LOAN_APPLICATION_STATUS = "UPDATE LoanApplication SET application_status = ? WHERE application_id = ?;";
    ...
    public static final String SQL_RESET_AUTO_INCREMENT_LOAN_APPLICATION = "ALTER TABLE LoanApplication AUTO_INCREMENT= ?;";
